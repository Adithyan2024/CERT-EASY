  ...
  function Header() {
    return (
      <>
        ...
        <motion.header
          className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-xl shadow-lg border-b border-slate-200/50" : "bg-white shadow-sm"}`}
          initial={{ y: -100 }}
          animate={{ y: 0 }}
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        ...
                        parent.innerHTML = '<div class="w-full h-full bg-gradient-to-br from-slate-700 via-teal-600 to-indigo-700 rounded-lg flex items-center justify-center"><svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path></svg></div>';
                      }
                    }}
                  />
                </div>
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        ...
                        svg.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>';
              ...
              <motion.div key={section.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: (index + 1) * 0.1 }}>
                ...
                <ul className="space-y-2">
                  {section.links.map((link) => (
                    <li key={link.name}>
                      <button onClick={link.onClick} className="transition-colors hover:translate-x-1 inline-block" style={{ color: "#4A5568" }}>
                        {link.name}
                      </button>
                    </li>
                  ))}
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div className="relative" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
                ...
                <motion.div className="absolute -bottom-6 -left-6 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 hidden lg:block border border-slate-200/50" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1 }} whileHover={{ scale: 1.05 }}>
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg">
                      <Award className="w-7 h-7 text-white" />
                    </div>
                    <div>
                      <div className="text-3xl bg-gradient-to-r from-slate-700 to-teal-600 bg-clip-text text-transparent" style={{ fontWeight: 700 }}>50,000+</div>
                      <div className="text-sm text-slate-600">Certified Students</div>
                    </div>
                  </div>
                </motion.div>

                <motion.div className="absolute top-6 -right-6 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl px-6 py-3 hidden lg:block border border-slate-200/50" initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 1.2 }} whileHover={{ scale: 1.05, rotate: 5 }}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-slate-700" style={{ fontWeight: 600 }}>4.9/5</span>
                  </div>
                </motion.div>
              </motion.div>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white border-y border-slate-200">
          <div className="max-w-7xl mx-auto">
            <motion.p className="text-center text-slate-600 mb-12" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              Trusted by leading certification providers worldwide
            </motion.p>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-8 items-center">
              {partners.map((partner, index) => (
                <motion.div key={partner.name} className="flex items-center justify-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ scale: 1.1, y: -5 }}>
                  <div className="text-slate-400 hover:text-slate-700 transition-colors text-center cursor-pointer" style={{ fontWeight: 700 }}>{partner.logo}</div>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section id="courses" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Badge className="bg-slate-100 text-slate-700 mb-4">Featured Courses</Badge>
              <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900" style={{ fontWeight: 700 }}>Popular Certification Courses</h2>
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">Choose from our comprehensive selection of industry-recognized certification programs</p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {courses.map((course, index) => (
                <motion.div key={course.id} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ y: -10 }}>
                  <Card className="overflow-hidden border-0 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 group h-full bg-white">
                    <div className="relative overflow-hidden">
                      ...
                      <motion.div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300" initial={{ y: 20 }} whileHover={{ y: 0 }}>
                    ...
                    <CardHeader className="space-y-3">
                      <Badge variant="outline" className="w-fit text-slate-700 border-slate-300">{course.level}</Badge>
                      <h3 className="text-slate-900 text-xl" style={{ fontWeight: 600 }}>{course.title}</h3>
                    </CardHeader>
                    ...
                    <CardFooter className="pt-0">
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full">
                        <Button className="bg-gradient-to-r from-slate-700 to-slate-900 hover:from-slate-800 hover:to-black text-white shadow-lg w-full" onClick={() => handleCourseClick(course.id)}>
                          Learn More
            ...
            <motion.div className="text-center mt-12" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button onClick={navigateToCourses} variant="outline" className="border-2 border-slate-700 text-slate-700 hover:bg-slate-50 px-8 py-6 group">
                  View All Courses
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
              </motion.div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Badge className="bg-teal-100 text-teal-700 mb-4">Learning Options</Badge>
              <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900" style={{ fontWeight: 700 }}>Flexible Learning Options</h2>
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">Choose the learning format that works best for you</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {learningOptions.map((option, index) => {
                ...
                return (
                  <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ y: -10 }}>
                    <Card className="border-2 border-slate-200 hover:border-slate-300 rounded-3xl transition-all duration-300 group h-full relative overflow-hidden shadow-lg hover:shadow-2xl">
                      ...
                      <CardHeader>
                        <motion.div className={`w-16 h-16 bg-gradient-to-br ${option.gradient} rounded-2xl flex items-center justify-center mb-4 shadow-lg`} whileHover={{ rotate: 360, scale: 1.1 }} transition={{ duration: 0.6 }}>
                          <Icon className="w-8 h-8 text-white" />
                        </motion.div>
                        <h3 className="text-slate-900 text-xl" style={{ fontWeight: 600 }}>{option.title}</h3>
                        <p className="text-slate-600">{option.description}</p>
                      </CardHeader>
                      <CardContent>
                        <ul className="space-y-3">
                          {option.features.map((feature, idx) => (
                            <motion.li key={idx} className="flex items-center gap-2 text-slate-700" initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }}>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { value: stats.students, suffix: "+", label: "Students Certified", icon: Users },
                { value: stats.courses, suffix: "+", label: "Courses Available", icon: BookOpen },
                { value: stats.instructors, suffix: "+", label: "Expert Instructors", icon: Award },
                { value: stats.satisfaction, suffix: "%", label: "Satisfaction Rate", icon: Heart },
              ].map((stat, index) => {
                const Icon = stat.icon;
                return (
                  <motion.div key={index} className="text-center" initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ scale: 1.05 }}>
                    <motion.div className="inline-flex items-center justify-center w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl mb-4" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
                      <Icon className="w-8 h-8" />
                    </motion.div>
                    <div className="text-5xl lg:text-6xl mb-2" style={{ fontWeight: 700 }}>{stat.value.toLocaleString()}{stat.suffix}</div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-5xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900" style={{ fontWeight: 700 }}>What Our Students Say</h2>
              <p className="text-xl text-slate-600">Real success stories from certified professionals</p>
            </motion.div>
              ...
              <CarouselContent>
                {testimonials.map((testimonial, index) => (
                  <CarouselItem key={index}>
                    <motion.div className="px-1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                      <Card className="border-0 rounded-3xl shadow-2xl bg-white">
                        <CardContent className="p-8 lg:p-12">
                          <motion.div className="flex gap-1 mb-6" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                          ...
                          <p className="text-xl text-slate-700 mb-8 italic leading-relaxed">"{testimonial.text}"</p>
                          <div className="flex items-center gap-4">
                            <motion.div whileHover={{ scale: 1.1 }} className="relative">
                              <ImageWithFallback src={testimonial.image} alt={testimonial.name} className="w-16 h-16 rounded-full object-cover ring-4 ring-slate-100" />
                              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-emerald-500 rounded-full border-4 border-white" />
                            </motion.div>
                            <div>
                              <div className="text-slate-900 text-lg" style={{ fontWeight: 600 }}>{testimonial.name}</div>
        ...
        <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Badge className="bg-amber-100 text-amber-700 mb-4">Why Choose Us</Badge>
              <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900" style={{ fontWeight: 700 }}>Why Choose Cert-Easy?</h2>
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">The complete certification training solution for professionals</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {whyChooseUs.map((item, index) => {
                ...
                return (
                  <motion.div key={index} className="flex gap-4 p-6 rounded-2xl hover:bg-slate-50 transition-colors group" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ scale: 1.05 }}>
                    <motion.div className={`w-14 h-14 bg-gradient-to-br ${item.color} rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg`} whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
                      <Icon className="w-7 h-7 text-white" />
                    </motion.div>
                    <div>
                      <h3 className="text-slate-900 mb-2 text-lg" style={{ fontWeight: 600 }}>{item.title}</h3>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-teal-50 to-indigo-50">
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Badge className="bg-indigo-100 text-indigo-700 mb-4">Certifications</Badge>
              <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900" style={{ fontWeight: 700 }}>Industry-Recognized Certifications</h2>
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">Earn credentials that open doors to new opportunities</p>
            </motion.div>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {certificates.map((cert, index) => (
                <motion.div key={index} initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ y: -10, rotate: 5 }}>
                  <Card className="border-2 border-slate-200 hover:border-slate-300 rounded-2xl cursor-pointer transition-all duration-300 group shadow-lg hover:shadow-2xl">
                    <CardContent className="p-6 text-center">
                      <motion.div className="w-16 h-16 bg-gradient-to-br from-slate-700 via-teal-600 to-indigo-700 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-lg" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
                        <Award className="w-8 h-8 text-white" />
                      </motion.div>
                      <div className="text-sm text-slate-900 mb-1" style={{ fontWeight: 600 }}>{cert.name}</div>
        ...
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Badge className="bg-violet-100 text-violet-700 mb-4">Contact</Badge>
              <h2 className="text-4xl lg:text-5xl mb-4 text-slate-900" style={{ fontWeight: 700 }}>Get In Touch</h2>
              <p className="text-xl text-slate-600">Have questions? We're here to help!</p>
            </motion.div>

            <div className="grid md:grid-cols-3 gap-8">
              {[
                { icon: Mail, title: "Email Us", info: ["info@Cert-Easy.com", "support@Cert-Easy.com"], color: "from-slate-600 to-slate-800" },
                { icon: Phone, title: "Call Us", info: ["+1 848-297-1003", "Mon-Fri 9am-6pm EST"], color: "from-teal-600 to-cyan-700" },
                { icon: MessageCircle, title: "WhatsApp", info: ["Click to chat with us", "Quick support available"], color: "from-emerald-600 to-green-700", onClick: handleWhatsAppClick },
              ].map((contact, index) => {
                const Icon = contact.icon;
                return (
                  <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ y: -10 }} onClick={contact.onClick} className={contact.onClick ? "cursor-pointer" : ""}>
                    <Card className="border-0 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 group">
                      <CardContent className="p-8 text-center">
                        <motion.div className={`w-16 h-16 bg-gradient-to-br ${contact.color} rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg`} whileHover={{ rotate: 360, scale: 1.1 }} transition={{ duration: 0.6 }}>
                          <Icon className="w-8 h-8 text-white" />
                        </motion.div>
                        <h3 className="text-slate-900 mb-2 text-xl" style={{ fontWeight: 600 }}>{contact.title}</h3>
